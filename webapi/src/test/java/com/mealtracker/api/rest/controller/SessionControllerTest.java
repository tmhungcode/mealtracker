...
import com.mealtracker.api.rest.SessionController;
...
/**
 * Controller layer tests for SessionController.
 * Tests authentication flow, token generation, and credential validation with
 * mocked services.
 */
...
@Tag("controller")
@Tag("webmvc")
@DisplayName("SessionController - User Login")
class SessionControllerTest {
    ...
    @Test
    @DisplayName("Login with valid credentials - Expect JWT token returned")
    void generateToken_Anonymous_ValidCredential_ExpectTokenReturned() throws Exception {
